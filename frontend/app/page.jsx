  ...
  return (
    <>
      <div className="bg-stone-50 min-h-screen text-stone-900">
        <section className="pt-32 pb-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              ...
              <Card
                className={`relative aspect-square md:aspect-4/5 border-4 border-stone-900 bg-stone-200 overflow-hidden py-0`}
              >
                <Image
                  src="/pasta-dish.png"
                ...
                <Card className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-sm border-2 border-stone-900 py-0">
                  <CardContent className="p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <Badge
                        variant="outline"
                        className="border-2 border-green-700 bg-green-50 text-green-700 font-bold mb-4"
                      >
                        98% MATCH
                      </Badge>
                    </div>
        ...
        <section className="py-8 border-y-2 border-stone-900 bg-stone-950">
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center px-4">
            {SITE_STATS.map((stat, i) => (
              <div key={i}>
                <div className="text-3xl font-bold mb-1 text-stone-50">
                  {stat.val}
                </div>
                <Badge
                  variant="secondary"
                  ...
                  >
                    <CardContent className={"p-6"}>
                      <div className="flex justify-between items-start mb-6">
                        <div className="border-2 border-stone-200 bg-orange-50 p-3 group-hover:border-orange-600 group-hover:bg-orange-100 transition-colors rounded-sm">
        ...
        <section className="py-24 px-4 border-y-2 border-stone-200 bg-stone-950 text-stone-50">
                ...
                return (
                  <div key={i}>
                    <div className="flex gap-6 items-start">
                      <Badge
                        variant="outline"
                        className="text-5xl font-bold text-orange-500 border-none bg-transparent p-0 h-auto"
                      >
                        {item.step}
                      </Badge>
                      <div>
