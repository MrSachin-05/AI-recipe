      ...
      <div className="container mx-auto max-w-5xl">
        <div className="mb-4">
          ...
          {itemsData?.scanLimit !== undefined && (
            <div className="bg-white py-3 px-4 border-2 border-stone-200 inline-flex items-center gap-3 rounded-sm hover:bg-orange-50 hover:border-orange-600 hover:shadow-lg">
              <Sparkles className="w-5 h-5 text-orange-600" />
              <div className="text-sm">
                {itemsData.scanLimit === "unlimited" ? (
                  <>
                    <span className="font-bold text-green-600">ထ</span>
            ...
            <div className="bg-linear-to-br from-green-600 to-emerald-500 text-white p-6 border-2 border-emerald-700 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-green-50 text-sm font-light">
                  ...
                  {editingId === item.documentId ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          {updating ? (
                            <Loader2 className="w-4 h-4 animate-ping" />
                          ) : (
